...
public class Baguette extends Subsystem {
    ...
    DigitalInput limit_Break = RobotMap.baguetteLimit_Break;
    DoubleSolenoid pumpernickel_Valve = RobotMap.baguettePumpernickel_Valve;
    ...
    /**
     * set the position of the pumpernickel
     * @param valvePosition valve position that the valve is set to
     */
    public void setPumpernickel_Valve(boolean valvePosition){
        if (valvePosition == PUMPERNICKEL_EXTENDED){
            pumpernickel_Valve.set(DoubleSolenoid.Value.kForward);
        } else {
            pumpernickel_Valve.set(DoubleSolenoid.Value.kReverse);
        }
